package com.chinacreator.asp.comp.sys.core.security.shiro.bean;
...
public class SimpleUser implements Serializable {
    ...
    public void setAuthorizationInfo(AuthorizationInfo authorizationInfo) {
        this.authorizationInfo = null == authorizationInfo ? null
                : authorizationInfo;
    }
    ...
    public void setUserWorkaddress(String userWorkaddress) {
        this.userWorkaddress = null == userWorkaddress ? null : userWorkaddress
                .trim();
    }
    ...
    public void setUserMobiletel1(String userMobiletel1) {
        this.userMobiletel1 = null == userMobiletel1 ? null : userMobiletel1
                .trim();
    }
    ...
    public void setUserMobiletel2(String userMobiletel2) {
        this.userMobiletel2 = null == userMobiletel2 ? null : userMobiletel2
                .trim();
    }
    ...
    public void setUserBirthday(Date userBirthday) {
        this.userBirthday = null == userBirthday ? null : (Date) userBirthday
                .clone();
    }
    ...
    public void setUserPostalcode(String userPostalcode) {
        this.userPostalcode = null == userPostalcode ? null : userPostalcode
                .trim();
    }
    ...
    public Date getUserRegdate() {
        return null == userRegdate ? null : (Date) userRegdate
                .clone();
    }

    public void setUserRegdate(Date userRegdate) {
        this.userRegdate = null == userRegdate ? null : (Date) userRegdate
                .clone();
    }
    ...
    public Date getLastloginDate() {
        return  null == lastloginDate ? null
