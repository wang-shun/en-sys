...
comment on column tb_sm_menu.creator is
'菜单创建者';

comment on column tb_sm_menu.creator_time is
'创建时间';

comment on column tb_sm_menu.sn is
'排序号';
...
'类型（0：功能组，1：静态操作，2：查询策略，3：决策策略，4：菜单）';
...
create table tb_system_info  (
   ...
   info_content         varchar2(200),
   info_desc            varchar2(100),
...
create table td_sm_log  (
   ...
   log_opertime         date                           default sysdate,
   log_content          clob,
   oper_type            number(1),
   remark1              varchar2(100),
...
comment on column td_sm_log.op_orgid is
'操作员所属机构ID';
...
create table td_sm_logconfig  (
   ...
   constraint pk_td_sm_logconfig primary key (menu_code)
);

comment on table td_sm_logconfig is
'日志配置表';

comment on column td_sm_logconfig.menu_code is
'菜单编码';
...
comment on column td_sm_log_his.op_orgid is
'操作员所属机构ID';
...
insert into td_sm_dictdata (dictdata_id, dicttype_id, dictdata_name, dictdata_value, dictdata_order, dictdata_isdefault) values ('11', '1', 'M', '男', 1, '1');
insert into td_sm_dictdata (dictdata_id, dicttype_id, dictdata_name, dictdata_value, dictdata_order, dictdata_isdefault) values ('12', '1', 'F', '女', 2, '1');
...
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('1', '1', null, 'fa-dashboard', '1', sysdate, 1);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('2', '1', null, 'fa-wrench', '1', sysdate, 2);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('3', '1', null, 'fa-book', '1', sysdate, 3);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('4', '1', null, 'fa-cogs', '1', sysdate, 4);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('11', '1', '#/f/personInfo', 'fa-user', '1', sysdate, 1);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('12', '1', '#/f/modifyPwd', 'fa-key', '1', sysdate, 2);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('21', '1', '#/f/jobMenuMain', 'fa-sitemap', '1', sysdate, 1);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('22', '1', '#/f/orgUserMain', 'fa-users', '1', sysdate, 2);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('23', '1', '#/f/dictMain', 'fa-list', '1', sysdate, 3);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('31', '1', '#/f/logQueryMain', 'fa-bookmark', '1', sysdate, 1);
insert into tb_sm_menu (menu_id, is_enabled, href, icon, creator, creator_time, sn) values ('41', '1', '#/f/sysInfoMain', 'fa-flask', '1', sysdate, 1);
