package com.chinacreator.asp.comp.sys.sdk.privilege.service;
...
public interface PrivilegeService {
    ...
    * @return true：存在，false：不存在
    */
    public boolean existsByPrivilegeCodeIgnorePrivilegeId(
        String privilegeCode, String privilegeId);
}
