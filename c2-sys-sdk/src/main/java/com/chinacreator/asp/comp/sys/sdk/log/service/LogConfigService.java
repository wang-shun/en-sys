...
import com.chinacreator.asp.comp.sys.sdk.log.dto.LogConfigDTO;
...
public interface LogConfigService {
    ...
    * 修改日志记录状态
    * @param operModule日志模块ID
    * @param logEnabled记录日志状态（true:可记录，false:不可记录）
    */
