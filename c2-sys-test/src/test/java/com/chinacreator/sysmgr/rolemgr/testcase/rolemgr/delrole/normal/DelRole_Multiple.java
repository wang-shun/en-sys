...
public class DelRole_Multiple extends TestCase{
	Logger logger = LoggerFactory.getLogger(DelRole_Multiple.class);
	@Test
	public void testDelRole_Multiple() throws Exception{
		...
		TestAll.driver.findElement(By.id("newField")).sendKeys("se");
