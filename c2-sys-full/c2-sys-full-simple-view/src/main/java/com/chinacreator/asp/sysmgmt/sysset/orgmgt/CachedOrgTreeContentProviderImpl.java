    ...
    public TreeNode[] getElements(TreeContext context) {
        ...
        if (null != context) {
            ...
            if ((null == orgId) || orgId.trim().equals("")) {
                ...
                rootOrgTreeNode.setName(OrgMgtMessages.getString(
                        "ORGMGT.ORG_ROOT_TREENAME"));
            ...
            OrgUserTreeCache cache = ApplicationContextManager.getContext()
                                                              .getBean(OrgUserTreeCache.class);
            List<OrgUserTreeNode> nodes = cache.getOrgUserTree().getTree(-1);
