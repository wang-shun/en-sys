...
public class LogArrayContentProviderImpl implements ArrayContentProvider {

	private LogService logService = ApplicationContextManager.getContext()
	...
	public Page<LogDTO> getElements(ArrayContext context) {
		...
		page = logService.queryByLog(logDTO, paramMap, context.getPageable(),
				context.getSortable());
		return page;
	}
}
